...
<div class="col-md-12" style="margin-top:15px;">
	 <div class="col-md-6">
		...
		<tr>
			...
			<td><b>State</b>  :  <span class="answer">{{ $equipment->project_state }}</span></td>
			<td ><b>City</b>  :  <span class="answer">{{ $equipment->project_city }}</span></td>
		</tr> 
		 	<tr>
			<td colspan="3"><b>Project Address</b>  :  <span class="answer">{{ $equipment->project_address }}</span></td>
...
<?php $achieverental = array_unique($achievedrental); ?>
  ...
  <div class="col-md-3 rental_objective_css">
  <br> 
  <span class=""><?php //echo ceil($diffdays/30);?></span> <span class="days_css"></span></div>
  
  <div class="col-md-3 rental_objective_css"> <br> <span class=""></span> <span class="days_css"></span></div>

  <div class="col-md-3 rental_objective_css"><br> <span class=""></span> <span class="days_css"></span></div>
  <div class="col-md-3 rental_objective_css"> <br> <span class=""></span> </div>
...
<table id="example1" class="table  table-striped" style="font-size: 12px;box-shadow: 0 2px 4px 0 rgba(181,181,181,.7);">
			 ...
			 <?php if(isset($singleday)){ if($dpr->date == $singleday->date){?>
			  ...
			  <td>
			  <?php if($dpr->logsheet){ ?>
			 <a href="{{url('/images')}}/{{ $dpr->logsheet }}" target="_blank">1 Logsheet</a>
