...
<div class="form-group col-md-3 nopad_5">
 ...
 <div class="form-group col-md-1 nopad">
   ...
   <input type="text" class=" form-control empty" placeholder="" name="e_vehicle_number" value="{{$request->e_vehicle_number}}" readonly>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
   <div class=" form-group col-md-1 nopad_5 ">
   
    <label for="exampleInputEmail1"><b>Shift </b><span class="required">*</span></label>
  <select class="form-control form_select_fil_2 empty" name="e_shift" >
  ...
  <option value="doubleshift" {{$request->e_shift == 'doubleshift'  ? 'selected' : ''}}>Double Shift</option>
   ...
   <input type="text" class="form-control empty" name="e_expected_mileage" placeholder="" style="border-right: none;border-top-right-radius: 0px!important;
