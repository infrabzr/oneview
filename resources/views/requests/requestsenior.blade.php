...
<div class="col-md-4"> 
  ...
  <div class="form-group col-md-12"> 
		 <input autocomplete="off"type="text" name="rental_start_date" id="e_rental_start_date" class=" datepicker first" size="5" placeholder="From"/>
		  <input autocomplete="off"type="text" name="rental_end_date" id="e_rental_end_date" onchange="myFunction(this.value)" class=" datepicker second" size="5" placeholder="To" />  
  </div>
  </div>
...
$(".first").datepicker({
  ...
  <div class="input-group my-group"> 
            ...
            <input autocomplete="off"type="text" class="form-control inputbox" name="noofdays" id="noofdays">
			<select   class="selectpicker form-control" data-live-search="true" title="Please select a lunch ..." name="noofdays_type">
							<option value=""></option>
  ...
  <div class="form-group col-md-2" >
   ...
   <div class="input-group my-group"> 
			...
			<select class="selectpicker form-control" data-live-search="true" title="Please select a lunch ..." name="rental_cost_type">
			<option value=""></option> 
  ...
  <div class="input-group my-group"> 
            ...
            <input autocomplete="off" type="text" class="form-control inputbox" name="billing_cycle" >
			<select   class="selectpicker form-control" data-live-search="true" title="Please select a lunch ..." name="billing_cycle_type">
			<option value=""></option>
                           <option value="Days">Days</option>
						  <option  value="Months">Months</option>
						  <option value="Years">Years</option>
