...
<div class="form-group col-md-3 nopad_5">
 ...
 <div class="form-group col-md-2">
    <label for="exampleInputEmail1"><b>Vechile No </b></label>
   <input type="text" class=" form-control" placeholder="" name="e_vehicle_number" >
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class=" form-group col-md-3 nopad_5 ">
   
    <label for="exampleInputEmail1"><b>Shift </b></label>
...
$(".first").datepicker({
  ...
  <div class="input-group my-group"> 
   ...
   <a target="_blank" href="{{url('/images')}}/{{ $request->upload_rental_contract }}"><button  type="button" style="    margin-top: 25px;">Download rental contract</button></a>
   </div>
