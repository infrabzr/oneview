...
<a target="_blank" href="{{url('/images')}}/{{ $request->d_vechile_rc }}"><i style="color:#000;font-size: 14px;vertical-align: middle;padding: 0px;" class="fa fa-eye" aria-hidden="true"></i></a>
<img onclick="approve('rc');" style="margin-right: 5px;" src="{{url('/images')}}/right.png">
<img onclick="reject('rc');" src="{{url('/images')}}/wrong.png">
...
<a target="_blank" href="{{url('/images')}}/{{ $request->d_fitness }}"><i style="color:#000;font-size: 14px;vertical-align: middle;padding: 0px;" class="fa fa-eye" aria-hidden="true"></i></a>
<img onclick="approve('insurance');" style="margin-right: 5px;" src="{{url('/images')}}/right.png">
<img onclick="reject('insurance');" src="{{url('/images')}}/wrong.png">
...
<a target="_blank" href="{{url('/images')}}/{{ $request->d_fitness }}"><i style="color:#000;font-size: 14px;vertical-align: middle;padding: 0px;" class="fa fa-eye" aria-hidden="true"></i></a>
<img onclick="approve('tax');" style="margin-right: 5px;" src="{{url('/images')}}/right.png">
<img onclick="reject('tax');" src="{{url('/images')}}/wrong.png">
...
<a target="_blank" href="{{url('/images')}}/{{ $request->d_fitness }}"><i style="color:#000;font-size: 14px;vertical-align: middle;padding: 0px;" class="fa fa-eye" aria-hidden="true"></i></a>
<img onclick="approve('permit');" style="margin-right: 5px;" src="{{url('/images')}}/right.png">
<img onclick="reject('permit');" src="{{url('/images')}}/wrong.png">
...
<a target="_blank" href="{{url('/images')}}/{{ $request->d_fitness }}"><i style="color:#000;font-size: 14px;vertical-align: middle;padding: 0px;" class="fa fa-eye" aria-hidden="true"></i></a>
<img  onclick="approve('fitness');" style="margin-right: 5px;" src="{{url('/images')}}/right.png">
<img onclick="reject('fitness');" src="{{url('/images')}}/wrong.png">
...
?>
<p style="text-align: center;"><button type="button" onclick="approved('fitness');" class="btn btn-primary">Approved</button>&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" onclick="hold('fitness');" class="btn btn-primary">hold</button></p>
</div>
...
function approved(doc){
   ...
   jQuery.ajax({
		...
		alert("your request was successfully submitted");
			window.location = "http://127.0.0.1:8000/requests/requestwidgetclick/4";
...
function hold(doc){
	var document = doc; 
	var r_id = $('#r_id').val(); 
   window.location = "http://127.0.0.1:8000/requests/requestwidgetclick/3";
   jQuery.ajax({
	    type: 'POST',
        url:'/home/approved',
