...
<div class="form-group col-md-3 nopad_5">
    <label for="exampleInputEmail1">Type</label>
		...
		<select id="type" class="form-control form_select_fil_1 @error('type') is-invalid @enderror" name="type" value="{{ old('type') }}"  disabled="true">
...
<div class="form-group col-md-3 nopad_5">
  ...
  <div class="form-group col-md-3 nopad_5">
    <label for="exampleInputEmail1">Equipment Type</label>
		<select  id="r_equipment_type" class="form-control  @error('r_equipment_type') is-invalid @enderror" name="r_equipment_type"   disabled="true">
			  <option value="">Select</option>
  ...
  <div class="form-group col-md-3 nopad_5">
   ...
   <select id="r_brand" class="form-control  @error('r_brand') is-invalid @enderror" name="r_brand"    disabled="true">
 ...
 <option  {{$request->r_brand == $brands_equipment[$key]->name  ? 'selected' : ''}} value="{{ $brands_equipment[$key]->brands_id }}">{{ $brands_equipment[$key]->name }}</option>
  ...
  <div class="col-md-12">
   <div class="form-group col-md-2 nopad_5">
    ...
    <select class="form-control " name="r_year"  disabled="true">
	  <option value="">Select</option>
 ...
 <div class="form-group col-md-1 nopad">
  ...
  <select class="form-control form_select_fil_2 " name="e_shift"  disabled="true">
