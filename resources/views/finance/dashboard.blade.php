    ...
    <div class="col-md-8 ratio">
						...
						<div class="notifyname1"> <!--<span><i class="fa fa-etsy" aria-hidden="true"></i></span>--></div>
						 ...
						 <div class="c100 p100 margin_left_24">
								<span>{{ $piechartdata[$key]->count }}</span>
								<div class="slice">
...
<div class="col-md-3 rental_objective_css">Rental Billing Cycle <span class="dollar_8">${{ $equipments[$key]->e_billing_cycle }}</span>
 ...
 <div class="col-md-1 view_right"><a href="http://18.225.35.19/finance/equipment_finance_detailview/{{ $equipments[$key]->e_id }}"><span class="view_css_new">View</span></a></div>
...
<a href="http://18.225.35.19/finance/equipment_finance_detailview/{{ $equipments[$key]->e_id }}"><span class="in_class_one">01</span></a>
<a href="http://18.225.35.19/finance/equipment_finance_detailview/{{ $equipments[$key]->e_id }}"><span class="in_class_two">02</span></a>
<a href="http://18.225.35.19/finance/equipment_finance_detailview/{{ $equipments[$key]->e_id }}"><span class="in_class_three">03</span></a>
<a href="http://18.225.35.19/finance/equipment_finance_detailview/{{ $equipments[$key]->e_id }}"><span class="in_class_four">04</span></a>
<?PHP  for( $i=5; $i<=31; $i++){ ?>
<a href="http://18.225.35.19/finance/equipment_finance_detailview/{{ $equipments[$key]->e_id }}"><span class="in_loopClass"><?php if($i<10){ echo 0; } echo $i; ?></span></a>
