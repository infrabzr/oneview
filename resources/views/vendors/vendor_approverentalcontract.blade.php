...
<div class="col-md-12">
	...
	<div class="col-md-12"><div style="font-weight: 600;padding-bottom: 1%;">Total Count: 5</div></div>
					...
					<div class="tab6"  style="background-color:white;padding: 7px !important;height:22vh; width: 10% !important;">
					...
					<div class="tab6" style="box-shadow: #000 0px 2px 24px -9px;background-color:#e8e8e8;padding: 7px !important;height:22vh;width: 10%;">
				  <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
...
$role = Auth::user()->role;
 ?>
			  ...
			  <?php }  else {  ?>
			  <a href="{{ URL('/requests/requestvendorapprove/'.$requests[$key]->r_id )}}"><span class="edit_icon_p"><i class="fa fa-eye" aria-hidden="true" style="font-size:1em;color:#000;"></i></span></a>
			  <?php }  ?>
