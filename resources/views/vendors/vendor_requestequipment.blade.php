...
<div class="col-md-12">
	...
	<div class="col-md-12"><div style="font-weight: 600;padding-bottom: 1%;">Total Count: 5</div></div>
					...
					<div class="tab6" style="box-shadow: #000 0px 2px 24px -9px;background-color:#e8e8e8;padding: 7px !important;height:24vh;width: 10%;">
				 ...
				 <br>
					 ...
					 <a href="{{ URL('home/rejectedrequests_v')}}"  style="    color: black;">
