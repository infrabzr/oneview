...
<div class="col-md-12">
	...
	<div class="col-md-12"><div style="font-weight: 600;padding-bottom: 1%;">Total Count: 5</div></div>

					<a href="{{ URL('home/vendor_requestequipment/1')}}"  style="    color: black;">
					<div class="tab6" style="box-shadow: #000 0px 2px 24px -9px;padding: 7px !important;height:24vh;width: 10%;">
					<div class="notifyname2"> <span><i class="fa fa-exclamation" aria-hidden="true"></i></span></div>
						 ...
						 <div class="c100 p100 margin_left_24" >
								<span style="color: #000;font-weight: 600;"><?php echo $newrequest_count; ?> </span>
								<div class="slice">
					...
					<a href="{{ URL('home/vpendingatclient')}}"  style="    color: black;">
					
					<div class="tab6" style="background-color:#e8e8e8;padding: 7px !important;height:24vh; width: 10% !important;">
				 <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
								<span style="color: #000;font-weight: 600;"><?php echo $approved_request_count; ?></span>
								<div class="slice">
									<div class="bar" style="border: 0.08em solid #a7161d" ></div> 
									<div class="fill" style="border: 0.08em solid #a7161d;"></div> 
								</div>
							</div>
							</div><div class="subtext">
										<span>Pending at client</span>	
					 ...
					 <a href="{{ URL('home/vendor_approvedrequests')}}"  style="    color: black;">
					
					<div class="tab6" style="background-color:white;padding: 7px !important;height:24vh; width: 10% !important;">
				 <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
					...
					<a href="{{ URL('/home/vendor_approverentalcontract')}}"  style="    color: black;">
					<div class="tab6" style="background-color:white;padding: 7px !important;height:24vh; width: 10% !important;">
				  <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
								<span style="color: #000;font-weight: 600;"><?php echo $approve_vendor_count; ?></span>
								<div class="slice">
									...
									<div class="fill" style="border: 0.08em solid #544bc1;"></div> 
										...
										<span>Accept Rental<br>Contract</span>			
...
<span class="main_heading"> Equipment Details</span><img class="side_fixel_20" src="{{ asset('newapp/filter20x20.png') }}"><img class="side_fixel_30" src="{{ asset('newapp/excavator35x35.png') }}">
 ...
 <span class="main_heading_num side_fixel_20">{{ $typeequipment_count }}</span><span class="line1" style="display:none;" ></span>
 <span style="display:none;"  class="add_sub_heading "><a href="{{URL::to('/home/newrequestadd') }}" style="color: #000;font-weight: 600;">New Request <i class="fa fa-plus-circle"></i></a>
 </span>
...
$role = Auth::user()->role;
 ?>
			  <?php if($role==4 || $role==3 && $requests[$key]->r_status == 5){ ?>
			  ...
			  <?php }  else {  ?>
			  <a href="{{ URL('/requests/rejectedrequests_vdetails/'.$requests[$key]->r_id )}}"><span class="edit_icon_p"><i class="fa fa-eye" aria-hidden="true" style="font-size:1em;color:#000;"></i></span></a>
			  <?php }  ?>
