...
$role = Auth::user()->role;
 ?>
			  ...
			  <?php }  else {  ?>
			  <a href="{{ URL('/requests/vpendingatclientdetails/'.$requests[$key]->r_id )}}"><span class="edit_icon_p"><i class="fa fa-eye" aria-hidden="true" style="font-size:1em;color:#000;"></i></span></a>
			  <?php }  ?>
