			 ...
			 <?php if(isset($singleday)){ if($dpr->date == $singleday->date){?>
			  ...
			  <td>-</td>
			   ...
			   <?php if($dpr->end_time){ ?>
				...
				<?php } else{ ?>
				 ...
				 <td><button   class="view_css_new  "  onclick="updatedetail(<?php echo $dpr->dpr_id; ?>)" style="font-size: 1.3em;background: linear-gradient( 95deg , rgba(79,74,194,1) 23%, rgba(151,83,175,1) 100%);    color: #fff;" style="">Update</button> </td>
				<?php } ?>
			  <?php }else{ ?>
			   <td>-</td>
			  <?php } }else{ ?> 
			  ...
			  <td ><span ><input type="text" onkeypress="return isNumberKey(this, event);" class="form-control textbox"  id="fueled_hide-<?php echo $i; ?>"></span><span  id="fueled_show-<?php echo $i; ?>">-</span></td>
				...
				<i  style="font-size: 1.7em; <?php  if( date('d') != $i ){ ?>color:  #999;<?php } ?>" class="showall fa fa-plus-circle hidebutton<?php echo $i; ?>" aria-hidden="true" onclick="myFunction(<?php echo $i; ?>)"></i>
				 <button   class="view_css_new hideall showbutton<?php echo $i; ?>"  onclick="savedetail(<?php echo $i; ?>)" style="font-size: 1.3em;display:none;    background: linear-gradient( 95deg , rgba(79,74,194,1) 23%, rgba(151,83,175,1) 100%);    color: #fff;" style="">Save</button> 
				</td>
			  </tr>  
              </tbody><tbody>
