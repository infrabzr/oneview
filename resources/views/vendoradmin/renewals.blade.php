...
<div class="col-md-7">
<h4 class="" >Renewal Equipment lease extensions </h4>
</div>
...
<div class="form-group col-md-2">
 ...
 <option value="{{ $vendorclients[$key]->id }}" <?php if($clientandprojectdata->clinet_id== $vendorclients[$key]->id){ echo "selected";}?>>{{ $vendorclients[$key]->name }}</option>
   @endforeach
</select>
  ...
  <div class="form-group col-md-2">
    <label for="exampleInputEmail1"> Person of contact <span class="required">*</span></label>
	  ...
	  <option > {{$clientandprojectdata->client_name}}</option>
	  </select>
  ...
  <div class="form-group col-md-2">
    ...
    <input type="text" class="form_select_fil_1 form-control" id="client_designation" placeholder="" name="client_designation" value="{{$clientandprojectdata->client_designation}}">
  ...
  <div class="form-group col-md-2">
   ...
   <input type="text" class="form_select_fil_1 form-control"  name="client_phoneno" id="client_phone" value="{{$clientandprojectdata->client_phoneno}}">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group col-md-2">
    <label for="exampleInputEmail1">Email ID <span class="required">*</span></label>
  <input type="text" class="form_select_fil_1 form-control"  name="client_emailid" id="contacts_email" value="{{$clientandprojectdata->client_emailid}}">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
 <!-- <div class="form-group col-md-2">
...
<div class="col-md-12 nopad margin_to_20 margin_bottom_20 border_solid_1px">
  ...
  <div class="form-group col-md-2">
	...
	<option value=" {{$clientandprojectdata->project_id}}"> {{$clientandprojectdata->project_name}}</option>
	  </select>
  ...
  <div class="form-group col-md-2">
    <label for="exampleInputEmail1">State <span class="required">*</span></label>
    <input type="text" class=" form_select_fil_1 form-control" id="project_state" placeholder="" name="project_state" value="{{$clientandprojectdata->project_state}}">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group col-md-2">
    <label for="exampleInputEmail1">City <span class="required">*</span></label>
   <input type="text" class="form_select_fil_1 form-control" id="project_city" placeholder="" name="project_city" value="{{$clientandprojectdata->project_city}}">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  ...
  <div class="form-group col-md-3">
   ...
   <textarea  class="form_select_fil_1 form-control " id="project_address" name="project_address">{{$clientandprojectdata->project_address}}</textarea>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
...
<input type="text" name="e_wom" class="form-control" required>
 ...
 <?php } ?>
  ...
  <option >Select</option>
 <option value="same" selected>Same Site</option>
 <option value="one">One Side</option>
  <option value="Two">Two Side</option>
   ...
   <div class=" col-md-2">
	...
	<label for="exampleInputEmail1"></label>
   <input type="text" class="form-control" name="mobilization_price"  placeholder="" style="" required value="0">
