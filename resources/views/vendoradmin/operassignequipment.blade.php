...
<tr>
  <td>{{$loop->iteration}}</td>
	  <td>{{ $assignequipemnet_data->oper_equipment_type }}</a></td>
 <td><a href="{{url('equipment_daily_checkup/')}}/{{$assignequipemnet_data->id}}">{{ $assignequipemnet_data->tech_code }}</a></td>
 <td>{{ $assignequipemnet_data->oper_state }}</td>
