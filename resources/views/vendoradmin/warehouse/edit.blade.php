...
<form method="post" action="/warehouse/update" enctype="multipart/form-data">
@csrf
...
<div class="col-md-12 nopad">
  ...
  <option value=" <?php echo $statedata->state_id; ?>" <?php if($statedata->state_id == $products['state_id']){ echo "selected"; } ?>><?php echo $statedata->state_name; ?></option>
   <?php } ?>
</select>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <input type="hidden" name="id" value="<?php echo $products['warehouse_name']; ?>">
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Clients</label>
  
  <select class="form-control form_select_fil_2" id="clients" name="client_id" required>
    <?php foreach($vendorclients as $vendorclientsdata){  ?>
  <option value=" <?php echo $vendorclientsdata->id; ?>" <?php if($vendorclientsdata->id == $products['client_id']){ echo "selected"; } ?>><?php echo $vendorclientsdata->name; ?></option>
   <?php } ?>
</select>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div> 
 ...
 <?php foreach($vendorprojects as $vendorprojectsdata){  ?>
  ...
  <input type="text" name="warehousename" class="form-control" value="<?php echo $products['warehouse_name']; ?>">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">&nbsp;</label>
    <input type="submit" class="form-control btn btn-success" value="Submit" placeholder="">  
