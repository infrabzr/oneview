...
">
  ...
  <table class="table table-bordered"><caption style="color:#000; text-align:center" > Warehouse List <a class="pull-right" href="{{URL::to('/warehouse/create') }}"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Warehouse</a></caption>
...
<tr>
<td><?php  echo $i; ?></td>
<td><?php  echo $warehousesdata->warehouse_name; ?></td>
<td><?php  echo $warehousesdata->project_name; ?></td>
<td><?php  echo $warehousesdata->client_name; ?></td>
<td><?php  echo $warehousesdata->state_name; ?></td>
 <td><a href="{{url('warehouse/edit/')}}/<?php  echo $warehousesdata->id; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><a href="{{url('warehouse/softDeletes/')}}/<?php  echo $warehousesdata->id; ?>"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></td>   
