...
<div class="col-md-12">
  ...
  <div class="tab-content">
    <div id="technician" class="tab-pane fade in active">
      <h3>Operator Planner</h3>
     <form method="post" action="/operatorplanner/store" enctype="multipart/form-data" onsubmit="return confirm('Do you really want to submit the form?');">
@csrf
