...
<form method="post" action="{{url('vendorequipment/userstore')}}" enctype="multipart/form-data">
@csrf
...
<div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Role <span class="required">*</span></label>
   <select class="form-control form_select_fil_2" id="product_type" name="role_type" required>
  <option value="">Select</option>
  <option value="8">Operator</option>
  ...
  <option value="demo2">Ex 200</option>
   ...
   <div class="form-group col-md-2 nopad_5">
    ...
    <input type="text" class="form-control"  placeholder="" name="user_phone" required pattern="[6-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaing 9 digit with 0-9">  
	<!--<select class="form-control form_select_fil_2" name="e_model">
  <option value="demo">EX 70</option>
  <option value="demo1">EX 110</option>
  <option value="demo2">Ex 200</option>
  ...
  <div class="form-group col-md-2 nopad_5">
    ...
    <input type="text" class="form-control"  placeholder="" name="user_email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  title="Contact's email (format: xxx@xxx.xxx)">  
	<!--<select class="form-control form_select_fil_2" name="e_model">
  <option value="demo">EX 70</option>
  <option value="demo1">EX 110</option>
  <option value="demo2">Ex 200</option>
   ...
   <div class="form-group col-md-2 nopad_5">
    ...
    <input type="text" class="form-control"  placeholder="" name="user_password"  pattern=".{9,}"   required title="9 characters minimum">  
	<!--<select class="form-control form_select_fil_2" name="e_model">
  <option value="demo">EX 70</option>
  <option value="demo1">EX 110</option>
  <option value="demo2">Ex 200</option>
...
background: linear-gradient(73deg, rgba(65,56,160,1) 23%, rgba(114,35,162,1) 100%);border: none;margin-top: 2%;"></button>
