...
<a class="nav-link " id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Rental Contract Details</a>
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-contact-tab" data-toggle="pill"   href="#profitdiv"  role="tab" aria-selected="false">Profit</a>
  </li>
</ul>
...
// if($araycheck==1){
  ...
  <?php $equipmentdalycheckups = $equipmentdalycheckups[0]; ?>
	  ...
	  @else
<?php //}else{ ?>
<form method="post" action="/technicianplanner/techdalycheckup" enctype="multipart/form-data" onsubmit="return confirm('Do you really want to submit the form?');">
@csrf  
<?php 
...
<label for="staticEmail" class="col-form-label">Service Status</label>
  ...
  <option value="completed" <?php if($servicecheckups->service_status=='completed'){ echo "selected"; } ?>>Completed</option>
	...
	<?php
	 ...
	 echo "<h3 class='text-center'>$days_between day to go Service time</h3>";
	 }  
	?>
