...
">
  ...
  <caption style="color:#000; text-align:center" >Sub Categories list <a class="pull-right" href="{{URL::to('/sparepartscategories/create') }}"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Sub Category</a></caption>
...
Action
   ...
   <tbody>
			  ...
			  @foreach($subcategories_list as $key => $val)
     
     

			  <tr>
			   <td>{{ $loop->iteration }}</td>
			  <td>{{ $subcategories_list[$key]->categoryname }}</td>    
			  <td>{{ $subcategories_list[$key]->name }}</td>    
			   <td><a href="{{url('sparepartssubcategories/edit/')}}/{{ $subcategories_list[$key]->id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><a href="{{url('sparepartscategories/softDeletes/')}}/{{ $subcategories_list[$key]->id }}"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></td> 
			  </tr>
