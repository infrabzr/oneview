...
<div id="London" class="tabcontent">
 ...
 <div class="col-md-12">
  ...
  <div class="col-md-12 maintable">
	<div class="col-md-12"><a class="pull-left" href="{{URL::to('/spareparts/create') }}"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Add SpareParts</a>  <a style="margin-left:5%" class="pull-left" href="{{URL::to('/sparepartscategories') }}"><i class="fa fa-list-alt" aria-hidden="true"></i>  Categories</a></div>
  <table class="table table-bordered">
    <caption style="color:#000; text-align:center" >Spare Parts List </caption>
...
Action
 ...
 <tbody>
			  ...
			  <td>{{ $spareparts_list[$key]->description }}</td>    
			  <td><img src="{{url('images/')}}/{{ $spareparts_list[$key]->image }}" style="width:60px; height:30px;"></td>    
			  <td>{{ $spareparts_list[$key]->manufacture }}</td>    
			  <td>{{ $spareparts_list[$key]->quantity }}</td>    
			  <td>{{ $spareparts_list[$key]->mfg_year }}</td>    
			  <td>{{ $spareparts_list[$key]->barcode }}</td>    
			  <td>{{ $spareparts_list[$key]->model_no }}</td>    
			  <td>{{ $spareparts_list[$key]->serial_no }}</td>    
			  <td><a href="{{url('spareparts/edit/')}}/{{ $spareparts_list[$key]->id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a><a href="{{url('spareparts/softDeletes/')}}/{{ $spareparts_list[$key]->id }}"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a><a href="{{url('spareparts/show/')}}/{{ $spareparts_list[$key]->id }}"><i class="fa fa-eye" aria-hidden="true"></i> View</a></td>    
			  </tr>
