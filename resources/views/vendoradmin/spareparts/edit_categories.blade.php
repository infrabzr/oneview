...
<form method="post" action="/sparepartscategories/update" enctype="multipart/form-data">
@csrf
...
<div class="col-md-12 nopad">
 ...
 <div class="form-group col-md-2 nopad_5">
  ...
  <input type="text" name="category_name" class="form-control" value="{{ $categories_data[0]->name}}">
    <small id="emailHelp" class="form-text text-muted"></small>
	<input type="hidden" name="id" value="{{ $categories_data[0]->id}}">
  </div>
