...
<form method="post" action="/spareparts/store" enctype="multipart/form-data">
@csrf
...
<div class="form-group col-md-2 nopad_5">
 ...
 <div class="form-group col-md-2 nopad_5">
  ...
  <select class="form-control form_select_fil_2" id="subcategory_id" name="sub_cat_id" required>
 ...
 <div class="form-group col-md-2 nopad_5">
  ...
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Product Price <span class="required">*</span></label>
  ...
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Manufacture <span class="required">*</span></label>
  <input type="text" name="manufacture" class="form-control">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Quantity  <span class="required">*</span></label>
  <input type="text" name="quantity" class="form-control">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Mfg Year  <span class="required">*</span></label>
  ...
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Model No <span class="required">*</span></label>
  <input type="text" name="modelno" class="form-control">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group col-md-2 nopad_5">
    <label for="exampleInputEmail1">Serial No <span class="required">*</span></label>
 ...
 <option value="">Select</option>
  ...
  <option value="{{ $vendorclients[$key]->project_id }}">{{$vendorclients[$key]->project_name }}</option>
     @endforeach
</select>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
