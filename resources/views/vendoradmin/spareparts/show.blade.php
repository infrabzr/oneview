...
">
  ...
  <div class="col-md-12">
	...
	<div class="col-md-12">
	<h2 style="color:#000; text-align:center" >Spare Parts Details </h2></div>

  <div class="col-md-4 maindivleft">
Category
</div>
 <div class="col-md-8 maindiv">{{ $productdata[0]->categoryname }}
 </div> 
  <div class="col-md-4 maindivleft">
Project Name
</div>
 <div class="col-md-8 maindiv">{{ $productdata[0]->project_name }}
 </div> 
...
Warehouse Name
 ...
 <div class="col-md-8 maindiv">{{ $productdata[0]->warehouse_name }}
 </div> 


 <div class="col-md-4 maindivleft">
Product name
</div> <div class="col-md-8 maindiv">{{ $productdata[0]->product_name }}</div>
 <div class="col-md-4 maindivleft">
Description
</div>
<div class="col-md-8 maindiv">{{ $productdata[0]->description }}</div>
 <div class="col-md-4 maindivleft">
Image
</div> 
<div class="col-md-8 maindiv"><img src="{{url('images/')}}/{{ $productdata[0]->image }}" style="width:40px;height:40px;"></div>
 <div class="col-md-4 maindivleft">
manufacture
</div>
 <div class="col-md-8 maindiv">{{ $productdata[0]->manufacture }}</div>
 <div class="col-md-4 maindivleft">
Quantity
</div>
 <div class="col-md-8 maindiv">{{ $productdata[0]->quantity }}</div>
 <div class="col-md-4 maindivleft">
Manufacturing Year
</div> 
<div class="col-md-8 maindiv">{{ $productdata[0]->mfg_year }}</div>
 <div class="col-md-4 maindivleft">
Barcode
</div> 
<div class="col-md-8 maindiv">{{ $productdata[0]->barcode }}</div>
 <div class="col-md-4 maindivleft">
Model No
</div> 
<div class="col-md-8 maindiv">{{ $productdata[0]->model_no }}</div>

 <div class="col-md-4 maindivleft">
Serial No
</div> 
<div class="col-md-8 maindiv">{{ $productdata[0]->serial_no }}</div>

 <div class="col-md-4 maindivleft">
Created at
</div> 
<div class="col-md-8 maindiv">{{ $productdata[0]->created_at }}</div>
  </div>
