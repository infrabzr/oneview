...
<div class="col-md-12">
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#technician">Technician</a></li>
...
<?php if($technician_users){ ?>
@foreach($technician_users as $technician_users_data)
<tr>
  <td>{{$loop->iteration}}</td>
	  <td><a href="{{url('assignequipemnet/')}}/<?php echo $technician_users_data->id; ?>">{{ $technician_users_data->name }}</a></td>
 <td>{{ $technician_users_data->clinetname }}</td>
 <td>{{ $technician_users_data->state }}</td>

<td>{{ $technician_users_data->ecount }}</td>
<td>{{ $technician_users_data->ecount }}</td>
</tr>
 @endforeach
<?php } ?>
...
@foreach($operator_users as $operator_users_data)
<tr>
  <td>{{$loop->iteration}}</td>
	  <td><a href="{{url('operassignequipment/')}}/<?php echo $operator_users_data->id; ?>">{{ $operator_users_data->name }}</a></td>
 <td>{{ $operator_users_data->clinetname }}</td>
 <td>{{ $operator_users_data->state }}</td>

<td>{{ $operator_users_data->ecount }}</td>
<td>{{ $operator_users_data->ecount }}</td>
</tr>
