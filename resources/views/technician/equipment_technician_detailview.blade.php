...
<script src="{{URL::to('fullcalendar/lib/jquery.min.js')}}"></script>
...
<div class="col-md-12" style="margin-top:15px;">
	 <div class="col-md-6">
		...
		<tr>
			<td><b>Equipment Name</b>  :  <span class="answer">{{ $equipment->ve_equipment_type }}</span></td>
...
<div class="col-md-12  margin_to_20 margin_bottom_20">
  ...
  <div class="col-md-4">
	...
	<div class="col-md-12" style="border-right:1px solid #c5c5c5;">	<div class="col-md-3"><img  class="fa_images" src="https://materialwala.com/buildsand/site_assets/newapp/owner_1.png"   /></div><div class="col-md-9"><span><b>Vendor Name</b></span><br><span style="color:#42b0c7;"> </span></div></div>
  
  </div>
  <div class="col-md-4">
 
	<div class="col-md-12" style="border-right:1px solid #c5c5c5;">	<div class="col-md-3"><img   class="fa_images"  src="https://materialwala.com/buildsand/site_assets/newapp/Owner_contact_2.png" /></div><div class="col-md-9"><span><b>Vendor Adderss</b></span><br><span  style="color:#42b0c7;"> </span></div></div>
 
  
  </div>
  <div class="col-md-4">
	 
	<div class="col-md-12" >	<div class="col-md-3"><img  class="fa_images"  src="https://materialwala.com/buildsand/site_assets/newapp/Vendor_contract_3.png" /></div><div class="col-md-9"><span><b>Vendor Contact</b></span><br><span  style="color:#42b0c7;"></span></div></div>
  </div>
...
<div class="col-md-12  ">
  ...
  <div class="col-md-4">
	...
	<div class="col-md-12" style="border-right:1px solid #c5c5c5;">	<div class="col-md-3"><img  class="fa_images" src="https://materialwala.com/buildsand/site_assets/newapp/Vendormail_4.png" /></div><div class="col-md-9"><span><b>Email Id</b></span><br><span  style="color:#42b0c7;"></span></div></div>
 ...
 <div class="modal-content" style="border-radius: 20px;">
    ...
    margin-bottom: 75px;font-size:13px;">
        <div class="col-md-12">
			...
			<div class="col-md-2"><b>Rental Start Date</b><div class="contract"></div></div>
			<div class="col-md-2"><b>Rental End Date</b><div  class="contract"></div></div>
			<div class="col-md-2"><b>No Of Days</b><div  class="contract">---</div></div>
			<div class="col-md-2"><b>Rental Cost</b><div  class="contract"></div></div>
			<div class="col-md-2"><b>Billing Cycle</b><br><div  class="contract"></div></div>
...
<div class="col-md-3"> {{ $equipment->rc_start_date }}</div>
...
<div class="col-md-3"> {{ $equipment->ins_start_date }}</div>
...
<div class="col-md-3"> {{ $equipment->tax_start_date }}</div>
...
<div class="col-md-3"> {{ $equipment->permit_start_date }}</div>
...
<div class="col-md-3"> {{ $equipment->fitness_start_date }}</div>
...
<?php $achieverental = array_unique($achievedrental); ?>
  ...
  <br> 
  <span class="dollar_8"><?php //echo ceil($diffdays/30);?></span> <span class="days_css">Hrs/   Hrs per month</span></div>
  
  <div class="col-md-3 rental_objective_css">Rental Billing Cycle <br> <span class="dollar_8"></span> <span class="days_css">Days</span></div>

  <div class="col-md-3 rental_objective_css">Rental Period <br> <span class="dollar_8"></span> <span class="days_css">year</span></div>
  <div class="col-md-3 rental_objective_css">Rental Price <br> <span class="dollar_8">Rs K</span> </div>
...
<div class="tabwidth8  tab5ico" style="background-color:#f71d0f; margin-top: 31%;background-image: none;"></div>	
  ...
  <div class="modal-content" style="border-radius: 20px;height:17vh;">
      ...
      <div style="">
        <div class="col-md-12">
			...
			<div class="col-md-3"><div class="contract_ach">29 Days</div></div>
			<div class="col-md-3"><div class="contract_idle">1 Days</div></div>
			<div class="col-md-3"><div class="contract_exce">0 Days</div></div>
  ...
  <option value="3">Critical</option>
    ...
    <div class="col-sm-6 nopad">
      <textarea class="custom-select form-control">
