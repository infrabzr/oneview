...
<caption class="text-center">Equipments Data</caption>
			  ...
			  <td>{{ $equipments[$key]->operatorname }} - {{ $equipments[$key]->mobile }}</td>
			  <td>
			  <a href="{{ URL('/technician_daily_checkup/'.$equipments[$key]->ve_id) }}"><span class="edit_icon_p"><i class="fa fa-eye" aria-hidden="true" style="font-size:1em;color:#000;"></i></span></a>
