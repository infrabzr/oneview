...
<div class="col-md-12">
    ...
    <div class="col-md-12 ratio">
					...
					<div class="tab7" <?php if($segment==1){ ?>style="box-shadow: #000 0px 2px 24px -9px;background-color:#e8e8e8;padding: 7px !important;height:22vh;width: 10%;" <?php } ?>>
					...
					<div class="tab7" <?php if($segment==2){ ?>style="box-shadow: #000 0px 2px 24px -9px;background-color:#e8e8e8;padding: 7px !important;height:22vh;width: 10%;" <?php } ?>>
				  <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
					...
					<div class="tab7" <?php if($segment==3){ ?>style="box-shadow: #000 0px 2px 24px -9px;background-color:#e8e8e8;padding: 7px !important;height:22vh;width: 10%;" <?php } ?>>
				  <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
					...
					<div class="tab7" <?php if($segment==4){ ?>style="box-shadow: #000 0px 2px 24px -9px;background-color:#e8e8e8;padding: 7px !important;height:22vh;width: 10%;" <?php } ?>>
				 <br>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile"> 
						 <div class="c100 p100 margin_left_24" >
...
<div class="col-md-12"><h1 class="heading">
<?php $uri = request()->segment(3); 
 if($uri==1){
	echo "New Equipment Request";
}else if($uri==2){
	echo "Request Pending at Vendor";
}else if($uri==3){
	echo "Approve RentalContract";
}else if($uri==4){
...
$role = Auth::user()->role;
 ?>
			  ...
			  <?php }  else {  ?>
			  <a href="{{ URL('/requests/filedsupervisorrequest_details/'.$requests[$key]->r_id )}}"><span class="edit_icon_p"><i class="fa fa-eye" aria-hidden="true" style="font-size:1em;color:#000;"></i></span></a>
			  <?php }  
