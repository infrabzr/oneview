...
<div class="col-md-12"style=" background: #fff; padding: 1%;margin-top: 1%;" ><div class="col-md-4"><span>Total Equipment:</span><span style="font-size:18px;"> <?php echo count($equipments); ?></span></div><div class="col-md-8 float-right" style="text-align: right;"><span>Project Code:</span><span class="textcolor"><?php echo $projectdata[0]->project_code; ?> </span><span class="paddingleft">Project Name:</span><span class="textcolor"><?php echo $projectdata[0]->project_name; ?> </span><span class="paddingleft">Site: </span><span class="textcolor"><?php echo $projectdata[0]->site_name; ?></span><span class="paddingleft">Phase:</span><span class="textcolor"><?php echo $projectdata[0]->phase; ?> </span></div></div>
    ...
    <div class="col-md-12 ratio">
						...
						<div class="notifyname1"> <!--<span><i class="fa fa-etsy" aria-hidden="true"></i></span>--></div>
						 ...
						 <div class="c100 p100 margin_left_24">
							...
							<div class="subtext">
								<span>{{ ucwords($piechartdata[$key]->e_equipment_type) }}</span>
							</div>
							</div>
...
<div class="col-md-12">
<div class="col-md-12 equipment_ratio" id="equipment_ratio_display">
<span class="main_heading"><?php echo ucwords($segment_users = request()->segment(3)); ?> DPR Details</span><img class="side_fixel_50" src="https://materialwala.com/buildsand/site_assets/newapp/filter20x20.png"><img class="side_fixel_30" src="https://materialwala.com/buildsand/site_assets/newapp/excavator35x35.png">
...
<div class="col-md-3 rental_objective_css">Rental Billing Cycle <span class="dollar_8">{{ $equipments[$key]->e_billing_cycle }}</span>
 ...
 <div class="col-md-1 view_right"><a href="<?php echo url("/fieldsupervisor/equipment_detailview/{$equipments[$key]->e_id}"); ?>"><span class="view_css_new">View</span></a></div>


<div class="col-md-11 nopad" style="    border-bottom: 6px solid #dcf1f2;    background: #dcf1f2;">
<a href="<?php echo url("/fieldsupervisor/equipment_detailview/{$equipments[$key]->e_id}"); ?>"><span class="in_class_one">01</span></a>
<a href="<?php echo url("/fieldsupervisor/equipment_detailview/{$equipments[$key]->e_id}"); ?>"><span class="in_class_two">02</span></a>
<a href="<?php echo url("/fieldsupervisor/equipment_detailview/{$equipments[$key]->e_id}"); ?>"><span class="in_class_three">03</span></a>
<a href="<?php echo url("/fieldsupervisor/equipment_detailview/{$equipments[$key]->e_id}"); ?>"><span class="in_class_four">04</span></a>
<?PHP  for( $i=5; $i<=31; $i++){ ?>
<a href="<?php echo url("/fieldsupervisor/equipment_detailview/{$equipments[$key]->e_id}"); ?>"><span class="in_loopClass"><?php if($i<10){ echo 0; } echo $i; ?></span></a>
<?php } ?>
</div><div class="col-md-1 percentage">
