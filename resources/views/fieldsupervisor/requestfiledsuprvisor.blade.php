...
<div class="form-group col-md-3 nopad_5">
    <label for="exampleInputEmail1">Product Type</label>
		...
		<select id="r_product_type" required class="form-control form_select_fil_1 @error('r_product_type') is-invalid @enderror" name="r_product_type"   >
			<option value="">Select</option>
  ...
  <div class="form-group col-md-3 nopad_5">
    <label for="exampleInputEmail1">Equipment Type</label>
		<select  id="r_equipment_type" required class="form-control form_select_fil_2 @error('r_equipment_type') is-invalid @enderror" name="r_equipment_type"  >
			  <option value="">Select</option>
  ...
  <div class="form-group col-md-3 nopad_5">
   ...
   <select id="r_brand" class="form-control form_select_fil_2 @error('r_brand') is-invalid @enderror" name="r_brand"  required >
	 <option value="">Select</option>
  ...
  <div class="form-group col-md-3 nopad_5">
    ...
    <select class="form-control form_select_fil_2" name="r_year" required>
	 <option value="">Select</option>
  ...
  <div class="col-md-6 ">
   <div class="form-group col-md-3 nopad_5">
	...
	<input autocomplete="off"id="r_model" required type="text" class="form-control @error('r_model') is-invalid @enderror" name="r_model" value=""   >
 
  </div>
  <div class="form-group col-md-3 nopad_5">
    <label for="exampleInputEmail1">Capacity</label>
   <input autocomplete="off"id="r_capacity" required type="text" class="form-control @error('r_capacity') is-invalid @enderror" name="r_capacity" value=""   >
 ...
 $('#r_project').on('change',function(e)
 {
    ...
    jQuery.ajax({
        ...
        success: function( data ){
			...
			var project_site = data.project_sites;
			console.log(data);
			console.log(newdata);
			 ...
			 $("#project_address").val(newdata[0].project_address); 
			 $("#field_supervisor").val(project_site[0].field_supervisor); 
