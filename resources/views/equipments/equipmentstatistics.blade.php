...
<div class="col-md-12">
    ...
    <div class="col-md-8 ratio1">
	<h1 class="mainh1">Equipment Details</h1>
<?php 
...
?>
	...
	<div class="col-md-3 ratio1" style="margin-right: 0%;margin-left: 1%; width: 25%;height: auto;"><div id="chartContainer" style="height: 27vh; width: 100%;"></div></div>
</div>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		indexLabel: "{y}",
		dataPoints: [
			{ label: "Total", y: {{$total_equipment_n}} },
