...
<div class="form-group col-md-2 nopad_5">
   ...
   <select class="form-control form_select_fil_1" name="e_product_type" required>
  ...
  <div class="form-group col-md-2 nopad_5">
   ...
   <select class="form-control form_select_fil_2" name="e_equipment_type" required>
  <option value="">Select</option>
  ...
  <div class="form-group col-md-2 nopad_5">
   ...
   <select class="form-control form_select_fil_2" name="e_brand" required>
  <option value="">Select</option>
  ...
  <div class="form-group col-md-2 nopad_5">
   ...
   <select class="form-control form_select_fil_2" name="e_year" required>
  ...
  <div class="form-group col-md-2 nopad_5">
    ...
    <input type="text" class="form-control"  placeholder="" name="e_model" required>  
 ...
 <div class="col-md-6 nopad form-group">
  ...
  <option value="500">500</option>
   ...
   <input type="text" class=" form-control"  placeholder="" name="e_vehicle_number" required>
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <input type="hidden" class=" form-control"  value="{{ Auth::user()->id }}" name="e_user_id" required>
  <div class=" form-group col-md-1 nopad_5 ">
...
<div class="form-group col-md-2">
   ...
   <select class="form-control form_select_fil_2" id="e_project_code" name="e_project_code" required>
