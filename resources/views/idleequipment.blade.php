...
?>
					...
					<a href="{{ URL('/home/idleequipment/')}}"><div class="tab6" style="background-color:white;padding: 7px !important;border: 2px solid #7c50b6 !important;">
					<div class="notifyname4"> <span><i class="fa fa-cog" aria-hidden="true"></i></span></div>
							<div class="col-md-12 nopad">
							<div class="col-md-12 card-body box-profile">
							<?php 
							$equipments_count = count($equipments);
							$equipments_count = ceil(($equipments_count/$total_equipment_n)*100); ?>
						 <div class="c100 p<?php echo $equipments_count; ?> margin_left_24">
								<span><?php echo $equipments_count; ?>%</span>
								<div class="slice">
									<div class="bar" style="border: 0.08em solid #7c50b6"></div>
									<?php if($equipments_count <=50){?>
									<div class="fill" ></div>
									<?php }else{ ?>
...
<h2 style="text-align:center;font-size: 18px;">Idle Equipment</h2>
<div class="col-md-12">
